        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <aside className="w-full lg:w-1/3 xl:w-1/4">
            <div className="lg:sticky lg:top-10">
              <h1 className="text-3xl lg:text-4xl font-extrabold mb-5">{title}</h1>
                  ...
                  <div className="p-4 flex flex-col flex-grow">
                    ...
                    <div className="mt-auto">
                      <Link to={`/Productdetail/${p.id}`}>
                        <button className="mt-3 w-full bg-black text-white py-2.5 rounded-lg font-medium hover:bg-gray-800 transition-colors">
                          View Product
                        </button>
                      </Link>
                    </div>
